...
[![Run FinOps Toolkit](https://github.com/cloudcwfranck/finazops/actions/workflows/run-app.yml/badge.svg)](https://github.com/cloudcwfranck/finazops/actions/workflows/run-app.yml)
